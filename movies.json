movies = {
  ...
  "Terminator 2": {
    ...
    "filmRating": "PG-13",
    "poster":
      "https://s3.amazonaws.com/ironboard-learn/terminator.jpg",
    "audienceScore": 8.8,
    "description":
      "The terminator is sent from the future to fight another terminator who is also from the future, but is liquid.",
    "cast": [
      {
        "role": "Terminator",
